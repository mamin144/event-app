...
class $AssetsIconsGen {
  ...
  SvgGenImage get activeHome =>
      const SvgGenImage('assets/icons/active_home.svg');

  /// File path: assets/icons/active_profile.svg
  SvgGenImage get activeProfile =>
      const SvgGenImage('assets/icons/active_profile.svg');
  ...
  /// File path: assets/icons/in_active_favorite.svg
  SvgGenImage get inActiveFavorite =>
      const SvgGenImage('assets/icons/in_active_favorite.svg');

  /// File path: assets/icons/in_active_home.svg
  SvgGenImage get inActiveHome =>
      const SvgGenImage('assets/icons/in_active_home.svg');

  /// File path: assets/icons/in_active_profile.svg
  SvgGenImage get inActiveProfile =>
      const SvgGenImage('assets/icons/in_active_profile.svg');
